...
namespace SMEQ.Areas.Admin.Controllers
{
    ...
    public class AccountAdminController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //{
            //    ModelState.AddModelError("", "Email chưa được xác nhận. Một mail vừa gửi vào hòm mail xin vui lòng vào mail xác nhận");
            ...
            //var Result =  _Account.VerifyAccount(model.Email, model.Password);
